              ...
              class="fas fa-plus fa-2x" aria-hidden="true"></i></a></span>
                        <table class="table table-bordered table-responsive-md table-striped text-center">
                            ...
                            <c:forEach var="product" items="${productList}">
                                <tr>
                                    <td class="pt-3-half"  contenteditable="true" ><c:out value="${product.id}"/></td>
                                    <td class="pt-3-half" contenteditable="true"  ><c:out value="${product.nameProduct}"/></td>
                                    <td class="pt-3-half" contenteditable="true"  ><c:out value="${product.price}"/></td>
                                    <td class="pt-3-half" contenteditable="true" ><c:out value="${product.amount}"/></td>
                                    <td class="pt-3-half" contenteditable="true" ><c:out value="${product.color}"/></td>
                                    <td class="pt-3-half" contenteditable="true"  ><c:out value="${product.description}"/></td>
